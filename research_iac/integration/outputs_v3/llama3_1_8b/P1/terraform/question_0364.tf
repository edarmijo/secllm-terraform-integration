...
resource "aws_lightsail_instance" "example" {
  ...
  iam_instance_profile_name = aws_iam_instance_profile.lightsail_profile.name
...
resource "aws_lightsail_load_balancer" "example" {
  name = "example-load-balancer"
}

resource "aws_lightsail_instance_attachment" "example" {
  instance_name = aws_lightsail_instance.example.name
  load_balancer_name = aws_lightsail_load_balancer.example.name
}