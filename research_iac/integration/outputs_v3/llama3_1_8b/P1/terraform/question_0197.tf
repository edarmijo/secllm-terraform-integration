...
resource "aws_iam_user" "cache_user1" {
  ...
  policies = [
    aws_iam_group_policy_attachment.cache_user_group_attach.arn,
  ]
}
...
resource "aws_iam_user_group_membership" "cache_user_group_membership" {
  ...
  user_ids        = [aws_iam_user.cache_user1.id, aws_iam_user.cache_user2.id, aws_iam_user.cache_user3.id]
