...
variable "aws_region" {
  type        = string
  description = "AWS region for the Aurora MySQL cluster"
}
...
variable "environment" {
  type        = string
  description = "Environment for the Aurora MySQL cluster"
}

variable "allowed_cidr_block" {
  type        = string
  description = "CIDR block for the Aurora MySQL cluster"
}

variable "subnet_ids" {
  type        = list(string)
  description = "Subnet IDs for the Aurora MySQL cluster"
}
