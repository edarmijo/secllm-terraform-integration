    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:elasticloadbalancing:${aws_region}:123456789012:loadbalancer/test-lb-tf",
          "arn:aws:elasticloadbalancing:${aws_region}:123456789012:targetgroup/test-lb-tf/12345678-1234-1234-1234-123456789012",
        ]
        Effect = "Allow"
      }
    ]
