...
data "aws_secretsmanager_secret" "rds_password" {
  name       = "RDS_Password"
  depends_on = [aws_iam_role_policy_attachment.rds_password]
}
...
resource "aws_db_instance" "default" {
  ...
  engine               = "mysql"
  username             = "admin"
  password             = data.aws_secretsmanager_secret_value.rds_password.secret_string
...
resource "aws_secretsmanager_secret_version" "rds_password" {
  ...
  secret_string = data.aws_secretsmanager_secret_value.rds_password.secret_string
}