...
resource "aws_db_instance" "mysql_instance" {
  ...
  iam_instance_profile   = aws_iam_role_policy_attachment.mysql_policy.id
}
...
resource "aws_iam_role_policy_attachment" "mysql_snapshot_policy" {
  role       = aws_iam_role.mysql_snapshot_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonRDSFullAccess"
}